...
#{
    set text(size: 12pt, fill: rgb(30, 100, 200))
    smallcaps[*Constraints for optimisation*]
}
...
#{
    set text(size: 12pt, fill: rgb(30, 100, 200))
    smallcaps[*Constraints as real-time feedback*]
}
...
#figurex(title: [ Hierarchy of constraints.], caption: [ Hierarchy of constraints, showing that all constraints are simulation constraints, within that are meta constraints within which are synthesisable constraints. ], kind: image)[
    #image(
...
#figurex(
    kind: image,
    title: [ Example visualisation of a time-domain simulation result. ],
    caption: [
