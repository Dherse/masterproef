...
This section serves as the motivation for the research and development of appropriate abstractions and tools for the design of photonic circuits, especially as it pertains to the programming of so-called Photonic @fpga[s] #cite("bogaerts_programmable_2020-1") or Photonic Processors. As with all other types of circuit designs, such as digital electronic circuits, analog electronic circuits and RF circuits, appropriate abstractions can allow the designer and/or engineer to focus on the functionality of their design rather than the implementation #cite("geiger_vlsi_1990"). One may draw parallels between the abstraction levels used when designing circuits and the abstractions used when designing software. Most notably the distinction made in the software-engineering world between imperative and declarative programming. The former is concerned with the "how" of the program while the latter is focused on the "what" of the program #cite("noauthor_imperative_2020").
...
Currently, a lot of the work being done, on photonic circuits, is done at a very low level of abstraction, close to the component-level #cite("bogaerts_silicon_2018"). This leads to several issues for broader access to the fields of photonic circuit design. Firstly, it requires expertise and understanding of the photonic component, their physics and the, sometimes complex, relationship between all of their design parameters. Secondly, it requires a large amount of time and effort to design and simulate a photonic circuit. Physical simulation of photonic circuit is generally slow #cite("bogaerts_silicon_2018", "alerstam_parallel_2008"), which has led to efforts to simulate photonic circuit using @spice #cite("ye_spice-compatible_2022"). Finally, the design and implementation of photonic circuit is generally expensive, requiring taping-out of the design and working with a froundry for fabrication. This increases the cost, but also increases the time to market for the product #cite("bogaerts_programmable_2020").
