...
This section serves as the motivation for the research and development of appropriate abstractions and tools for the design of photonic circuits, especially as it pertains to the programming of so-called Photonic #gloss("fpga", suffix: "s") #cite("bogaerts_programmable_2020-1") or Photonic Processors. As with all other types of circuit designs, such as digital electronic circuits, analog electronic circuits and RF circuits, appropriate abstractions can allow the designer and/or engineer to focus on the functionality of their design rather than the implementation. One may draw parallels between the abstraction levels used when designing circuits and the abstractions used when designing software. Most notably the distinction made in the software-engineering world between imperative and declarative programming. The former is concerned with the "how" of the program while the latter is focused on the "what" of the program #cite("noauthor_imperative_2020").
...
Currently, a lot of the work being done, on photonic circuits, is done at a very low level of abstraction, close to the component-level #cite("bogaerts_silicon_2018"). This leads to several issues for broader access to the fields of photonic circuit design. Firstly, it requires expertise and understanding of the photonic component, their physics and the, sometimes complex, relationship between all of their design parameters. Secondly, it requires a large amount of time and effort to design and simulate a photonic circuit. Physical simulation of photonic circuit is generally slow #cite("bogaerts_silicon_2018", "alerstam_parallel_2008"), which has led to efforts to simulate photonic circuit using #gloss("spice") #cite("ye_spice-compatible_2022"). Finally, the design and implementation of photonic circuit is generally expensive, requiring taping-out of the design and working with a fab for fabrication. This increases the cost, but also increases the time to market for the product #cite("bogaerts_programmable_2020").

This therefore means, that there is a large interest in constructing new abstractions, method of simulation and design tools for photonic circuit design. Especially for rapid prototyping and iteration of photonic design. This is the reason that research in the field of programmable photonics, and especially recirculating programmable photonics has had growing interest in the past few years. This master's thesis has the singular purpose of finding ways in which the user can easily design their photonic circuit and program them onto those programmable #gloss("pic", suffix: "s") #cite("bogaerts_programmable_2020"). This interest has culminated in the work being done as part of the #gloss("prg").

Additionally, photonic circuits are often not the only component in a system. They are often used in conjunction with other technologies, such as analog electronics, used in driving the photonic components, digital electronic, to provide control and feedback loops and #gloss("rf") to benefit from the high bandwidth, high speed capabilities of photonics #cite("marpaung_integrated_2019"). Therefore, it is of interest to the user to co-simulate #cite("bogaerts_silicon_2018", "sorace-agaskar_electro-optical_2015") their photonic circuits with the other components of their systems. This is a problem that is partly addressed using #gloss("spice") simulation #cite("ye_spice-compatible_2022"). However, especially with regards to digital co-simulation, #gloss("spice") tools are often lacking, making the process difficult #cite("osti_1488489"), relying instead on alternative such as #gloss("verilog-a").
...
+ How to translate that intent into a programmable #gloss("pic") configuration?
