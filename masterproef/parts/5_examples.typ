...
#ufigure(
  ...
  caption: [
    @phos implementation of a configurable optical beamforming system. A fully commented version is available in @anx_beam_forming.
  ],
)[
  ```phos
    syn beam_forming(
...
#ufigure(
  ...
  caption: [
    Simulation results of the beamforming system, showing the time-dependent phase shifts applied to the optical signals.
  ],
  kind: image,
  table(
    columns: (auto, 1fr),
...
#udefinition(footer: [ Adapted from @ref_qam. ])[
...
#ufigure(
  ...
  caption: [
    Error vector magnitude -- reference plot, showing the reference and measured IQ points, and the @evm vector of the sample.
  ],
  image(
...
#ufigure(
  ...
  caption: [
    16-#gloss("qam", short: true) modulator circuit, showing the splitter, modulators, phase shifters, and interferometer.
  ],
  image(
...
#ufigure(
  ...
  caption: [
    Simulation results of a 16-#gloss("qam", short: true) modulator, showing the input signal, the output signal, and the intermediary signals, along with the constellation points, and reference points. The constellation points have been normalized before being shown.
  ],
  image(
...
#ufigure(
  ...
  caption: [
    @mzi based lattice filter in @phos, parametrically generated for the user, fully commented example in @anx_lattice_filter.
  ],
)[
  ```phos
